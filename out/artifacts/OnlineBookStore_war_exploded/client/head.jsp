...
<div  style="height:60px;background-color:black;color:white">
    <a href="${pageContext.request.contextPath }/index.jsp" target="body">  <img src="${pageContext.request.contextPath }/icons/homePage.png" homepage class="post-thumb" height="40" weight="40" calss></a>
    <br>
    <br>
